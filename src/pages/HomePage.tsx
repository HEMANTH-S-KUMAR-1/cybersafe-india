        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-4 sm:mb-6 text-shadow animate-slide-up leading-tight">
              Stay Safe Online
              <span className="block text-digital-orange mt-1 sm:mt-2">Cyber Awareness for All</span>
            </h1>
            <p className="hindi text-xl sm:text-2xl md:text-3xl font-semibold text-gray-700 mb-6 sm:mb-8 animate-slide-up">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 animate-slide-up px-4 sm:px-0">
              ...
              <Link to="/respond" className="btn-secondary text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4 w-full sm:w-auto">
                <span className="block">Report Scam</span>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
            {quickStats.map((stat, index) => (
              <div key={index} className="text-center animate-slide-up p-3 sm:p-0">
                ...
                <div className="text-xs sm:text-sm hindi text-gray-500">{stat.hindi}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-surface">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="hindi text-xl sm:text-2xl text-accent mb-3 sm:mb-4 font-medium">हर किसी के लिए अनुकूलित साइबर सुरक्षा</p>
            ...
            {demographics.map((demo) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-lg sm:text-xl font-semibold text-heading mb-2 sm:mb-3">{demo.title}</h3>
                  <p className="hindi text-sm sm:text-base text-accent mb-3 sm:mb-4 font-medium">{demo.hindi}</p>
                  <p className="text-text-secondary text-sm sm:text-base leading-relaxed mb-3 sm:mb-4">{demo.description}</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 sm:mb-8 gap-4">
            <div>
              ...
              <p className="hindi text-base sm:text-lg text-gray-600">नवीनतम साइबर अलर्ट</p>
            </div>
            <Link to="/respond" className="btn-primary w-full sm:w-auto text-center">
              View All Alerts
            </Link>
          </div>
      ...
      <section className="py-12 sm:py-16 quick-access-gradient border-t border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="hindi text-lg sm:text-xl mb-2 text-text-secondary">त्वरित पहुंच</p>
